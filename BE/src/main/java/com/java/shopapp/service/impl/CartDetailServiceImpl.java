...
public class CartDetailServiceImpl implements CartDetailService{
    ...
    public CartDetailResponse createCartDetail(CartDetailRequest cartDetailRequest) {
        ...
        CartDetail cartDetail = cartDetailRepository
                .findByProductIdAndSize(cartDetailRequest.getProductId(), cartDetailRequest.getSize());
        if (cartDetail == null) {
            ...
            cartDetail.setNumberOfProducts(cartDetail.getNumberOfProducts() + cartDetailRequest.getNumberOfProducts());
            cartDetail.setTotalMoney(cartDetailRequest.getTotalMoney() + cartDetailRequest.getTotalMoney());
